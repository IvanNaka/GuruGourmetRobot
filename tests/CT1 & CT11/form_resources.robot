...
Digitar no campo cargo o nome do cargo do usuario
	Input Text	css:input[name=inputProp2]          ${CARGO}
	
Digitar no campo empresa o nome da empresa do usuario
	Input Text	css:input[name=inputProp3]          ${EMPRESA}
